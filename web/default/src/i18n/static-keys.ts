...
export const STATIC_I18N_KEYS = [
  ...
  'Moonshot',
  'Unified endpoint',
  'Use one relay entrance for chat, responses, embeddings, images, and multimodal requests.',
  'Visible cost state',
  'Model access, quota balance, and request usage stay readable before the call leaves your app.',
  'Provider shaped routing',
  'OpenAI-compatible clients can move across upstream model families with fewer integration changes.',
  'Route many upstream AI providers through one consistent API entrance.',
  'Let users understand balance, model availability, and usage before production traffic grows.',
  'Keep developer integration simple while operations can change channels, groups, and pricing behind the relay.',
  '我们不生产水，我们只是大自然的搬运工。为中国的 token 出海贡献一份力量。',
  '永续的 Vibe Coding 助手，无需再担心掉线、封号。',
  '永续的 Vibe Coding 助手',
  '无需担心掉线、封号。',
  '我们不生产水，我们只是大自然的搬运工。',
  '为中国的 token 出海贡献一份自己的力量。',
  '云是汉字云，Bay 是英语港湾，云贝就是网上的 AI 港口。',
  'OpenAI SDK compatible access',
  'Channel pools and automatic failover',
  'Group permissions and quota billing',
  'Usage audit, pricing ratios, and model aliases',
  'GBT5.5 full-power official edition at one tenth of the official price.',
  'Persistent coding route',
  'Hold and drag the point field. The harbor keeps routes visible while the models move behind it.',
  'An AI harbor for model traffic',
  'Aggregate upstream accounts, model permissions, and channel health behind one API control plane.',
  'Expose balance, quota, pricing ratio, token usage, and request logs before cost becomes invisible.',
  'Keep clients OpenAI-compatible while operations adjust routes, groups, aliases, and failover policies.',
  ...
  'For Apple Silicon and Intel Mac',
  'Download for macOS',
  'For Windows 10 / 11',
