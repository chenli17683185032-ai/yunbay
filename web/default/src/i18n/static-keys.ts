...
export const STATIC_I18N_KEYS = [
  ...
  'GPT 5.6 Sol',
  'Extreme reasoning',
  'Next: choose a model and review its price.',
  ...
  'Mac',
  'Universal download for Intel and Apple Silicon Macs.',
  'macOS 12 or later · Signed and notarized',
  'Download for Mac',
  'Windows',
  'Standard 64-bit installer for Windows 10 and Windows 11.',
