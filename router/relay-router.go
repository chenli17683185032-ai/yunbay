...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.ValuePackageEntitlement())
	{
	...
	geminiRouter.Use(middleware.ValuePackageEntitlement())
	{
	...
	geminiCompatibleRouter.Use(middleware.ValuePackageEntitlement())
	{
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.ValuePackageEntitlement(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.ValuePackageEntitlement())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.ValuePackageEntitlement(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.ValuePackageEntitlement())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.ValuePackageEntitlement(), middleware.Distribute())
	{
