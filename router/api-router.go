...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		channelConsoleRoute.Use(middleware.AdminAuth())
		{
			...
			channelConsoleRoute.GET("/cliproxy/status", controller.GetChannelConsoleCliProxyStatus)
			channelConsoleRoute.GET("/cliproxy/auth-files", controller.ListChannelConsoleCliProxyAuthFiles)
			channelConsoleRoute.POST("/cliproxy/auth-files", middleware.CriticalRateLimit(), controller.UploadChannelConsoleCliProxyAuthFile)
			channelConsoleRoute.POST("/cliproxy/auth-files/batch-delete", middleware.CriticalRateLimit(), controller.DeleteChannelConsoleCliProxyAuthFiles)
			channelConsoleRoute.GET("/cliproxy/auth-url", middleware.CriticalRateLimit(), controller.GetChannelConsoleCliProxyAuthURL)
			channelConsoleRoute.GET("/pools", controller.ListChannelConsoleCredentialPools)
			channelConsoleRoute.POST("/pools", middleware.CriticalRateLimit(), controller.CreateChannelConsoleCredentialPool)
			channelConsoleRoute.GET("/pools/:id", controller.GetChannelConsoleCredentialPool)
			channelConsoleRoute.POST("/pools/:id/credentials/api-key", middleware.CriticalRateLimit(), controller.AddChannelConsoleThirdPartyCredential)
			channelConsoleRoute.POST("/pools/:id/credentials/cliproxy-auth", middleware.CriticalRateLimit(), controller.AddChannelConsoleCliProxyCredential)
			channelConsoleRoute.POST("/credentials/batch-delete", middleware.CriticalRateLimit(), controller.BatchDeleteChannelConsoleCredentials)
			channelConsoleRoute.GET("/channels", controller.ListChannelConsoleChannels)
			channelConsoleRoute.POST("/channels/batch-delete", middleware.CriticalRateLimit(), controller.BatchDeleteChannelConsoleChannels)
