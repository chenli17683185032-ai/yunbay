	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/affiliate/withdrawals", controller.CreateAffiliateWithdrawal)
				...
				selfRoute.POST("/svip-celebration/seen", controller.MarkSVIPCelebrationSeen)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/group-tags", controller.GetUserGroupTags)
				adminRoute.GET("/topup", controller.GetAllTopUps)
				adminRoute.POST("/topup/complete", controller.AdminCompleteTopUp)
				adminRoute.GET("/affiliate/withdrawals", controller.GetAffiliateWithdrawals)
				adminRoute.POST("/affiliate/withdrawals/:id/paid", controller.MarkAffiliateWithdrawalPaid)
		...
		ldxpWorkerRoute := apiRouter.Group("/ldxp/worker")
		{
			...
			ldxpWorkerRoute.POST("/sessions/claim-paid-watch", anonymousRequestBodyLimit, controller.WorkerClaimLdxpPaidWatchSession)
			ldxpWorkerRoute.POST("/sessions/:session_id/active", anonymousRequestBodyLimit, controller.WorkerGetLdxpSessionActive)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/plans/:id/redemptions", controller.AdminCreateSubscriptionRedemptions)
		...
		ratioSyncRoute.Use(middleware.RootAuth())
		{
			...
			ratioSyncRoute.POST("/model_price/preview", controller.PreviewModelPriceSync)
			ratioSyncRoute.POST("/model_price/apply", controller.ApplyModelPriceSync)
		}
