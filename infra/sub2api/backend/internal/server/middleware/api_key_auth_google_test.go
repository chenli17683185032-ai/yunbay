...
func TestApiKeyAuthWithSubscriptionGoogle_StandardModeDoesNotRequireBalance(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestApiKeyAuthWithSubscriptionGoogle_IgnoresSubscriptionUsageLimitsInAuth(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestApiKeyAuthWithSubscriptionGoogle_RejectsMissingSubscription(t *testing.T) {
	gin.SetMode(gin.TestMode)

	group := &service.Group{
		ID:               79,
		Name:             "gemini-missing-subscription",
		Status:           service.StatusActive,
		Platform:         service.PlatformGemini,
		Hydrated:         true,
		SubscriptionType: service.SubscriptionTypeSubscription,
...
func TestApiKeyAuthWithSubscriptionGoogle_RejectsExpiredSubscription(t *testing.T) {
	gin.SetMode(gin.TestMode)

	group := &service.Group{
		ID:               80,
		Name:             "gemini-expired-subscription",
		Status:           service.StatusActive,
		Platform:         service.PlatformGemini,
		Hydrated:         true,
		SubscriptionType: service.SubscriptionTypeSubscription,
